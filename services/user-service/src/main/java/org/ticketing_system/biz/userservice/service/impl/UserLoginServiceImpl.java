...
import org.ticketing_system.biz.userservice.dao.entity.UserReuseDO;
...
import org.ticketing_system.biz.userservice.dao.mapper.UserPhoneMapper;
import org.ticketing_system.biz.userservice.dao.mapper.UserReuseMapper;
import org.ticketing_system.biz.userservice.dto.req.UserDeletionReqDTO;
import org.ticketing_system.biz.userservice.dto.req.UserLoginReqDTO;
import org.ticketing_system.biz.userservice.dto.req.UserRegisterReqDTO;
import org.ticketing_system.biz.userservice.dto.resp.UserLoginRespDTO;
import org.ticketing_system.biz.userservice.dto.resp.UserQueryRespDTO;
import org.ticketing_system.biz.userservice.dto.resp.UserRegisterRespDTO;
...
import org.ticketing_system.frameworks.starter.user.toolkit.JWTUtil;
...
import static org.ticketing_system.biz.userservice.common.constant.RedisKeyConstant.LOCK_USER_REGISTER;
import static org.ticketing_system.biz.userservice.common.constant.RedisKeyConstant.USER_DELETION;
import static org.ticketing_system.biz.userservice.common.constant.RedisKeyConstant.USER_REGISTER_REUSE_SHARDING;
import static org.ticketing_system.biz.userservice.common.enums.UserRegisterErrorCodeEnum.HAS_USERNAME_NOTNULL;
import static org.ticketing_system.biz.userservice.common.enums.UserRegisterErrorCodeEnum.MAIL_REGISTERED;
import static org.ticketing_system.biz.userservice.common.enums.UserRegisterErrorCodeEnum.PHONE_REGISTERED;
import static org.ticketing_system.biz.userservice.common.enums.UserRegisterErrorCodeEnum.USER_REGISTER_FAIL;
import static org.ticketing_system.biz.userservice.toolkit.UserReuseUtil.hashShardingIdx;
...
public class UserLoginServiceImpl implements UserLoginService {
    ...
    public void deletion(UserDeletionReqDTO requestParam) {
        ...
        // 加锁为什么放在 try 语句外？https://www.yuque.com/magestack/ticketing_system/pu52u29i6eb1c5wh
        lock.lock();
        try {
