package org.ticketing_system.framework.starter.log.core;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(org.ticketing_system.framework.starter.log.annotation.ILog) || @annotation(org.ticketing_system.framework.starter.log.annotation.ILog)")
